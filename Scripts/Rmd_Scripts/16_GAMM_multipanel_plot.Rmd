...
```{r}
here::i_am("Scripts/Rmd_Scripts/16_Gamm_multipanel_plot.Rmd")
library(tidyverse)
library(grid)
library(gridExtra)
library(ggpubr)
...
#### create a new list with the panels in the order needed for plotting (they are plotted row-wise but my_panels has them column_wise)
```{r}
