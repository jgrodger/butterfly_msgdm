...
png(file = paste0(out_path, params$dataset, "_", "zeta_decline_to_10.png"), pointsize=10, width=1400, height=960, res=300)
par(mfrow = c(2,2))
...
png(file = paste0(out_path, params$dataset, "_", "zeta_decline_to_50.png"), pointsize=10, width=1400, height=960, res=300)
par(mfrow = c(2,2))
Plot.zeta.decline(zd, arrange.plots = FALSE)
dev.off()
...
png(file = paste0(out_path, params$dataset, "_", "zeta_decline_to_250.png"), pointsize=10, width=1400, height=960, res=300)
par(mfrow = c(2,2))
Plot.zeta.decline(zd, arrange.plots = FALSE)
dev.off()
