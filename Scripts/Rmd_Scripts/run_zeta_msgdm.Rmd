...
```{r}
render_report(analysis_script = "GAM_analyses.Rmd", list(dataset = "wc_no_zeros"))
```
...
```{r}
render_report(analysis_script = "GAMM_analyses.Rmd", list(dataset = "wc_no_zeros"))
```
...
render_report(analysis_script = "Zeta_msgdm_analyses.Rmd", list(dataset = "all_species",  
              orders_msgdm =  c(2,3, 6, 10, 15, 20), sam_msgdm = 50000, normalize_msgdm = "Sorensen"))

render_report(analysis_script = "Zeta_msgdm_analyses.Rmd", list(dataset = "all_species",  
              orders_msgdm =  c(2,3, 6, 10, 15, 20), sam_msgdm = 50000, normalize_msgdm = "Simpson"))
...
render_report(analysis_script = "Zeta_msgdm_analyses.Rmd", list(dataset = "hs_no_zeros",  
              orders_msgdm =  c(2,3,4, 6), sam_msgdm = 50000, normalize_msgdm = "Sorensen"))

render_report(analysis_script = "Zeta_msgdm_analyses.Rmd", list(dataset = "hs_no_zeros",  
              orders_msgdm =  c(2,3, 4, 6), sam_msgdm = 50000, normalize_msgdm = "Simpson"))
