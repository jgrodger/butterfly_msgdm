...
```{r}
tic()
render_report(analysis_script = "Zeta_declines_decays_analyses.Rmd", list(dataset = "all_species", sam_ddecay = 100, orders_ddecay = 2:100))
toc()
tic()
render_report(analysis_script = "Zeta_declines_decays_analyses.Rmd", list(dataset = "wc", sam_ddecay = 100, orders_ddecay = 2:100))
toc()
...
tic()
render_report(analysis_script = "Zeta_declines_decays_analyses.Rmd", list(dataset = "hs", sam_ddecay = 100, orders_ddecay = 2:8)) # Computational issues at higher orders
toc()
tic()
render_report(analysis_script = "Zeta_declines_decays_analyses.Rmd", list(dataset = "hs_no_zeros", sam_ddecay = 100, orders_ddecay = 2:10)) # Computational issues at higher orders
toc()
```
