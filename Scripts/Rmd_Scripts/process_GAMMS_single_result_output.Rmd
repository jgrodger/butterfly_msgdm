...
#### Write summary of gamm$gam to a text file
```{r, comment = "", label = 'Table XXX'}
...
p_sum3 <- data.frame(Thing = c("Family", "Link", "R-sq.(adj)", "Scale est.", "n"), Value = c(my_fam, my_link, my_rsq, my_scale, my_n))
