...
```{r}
here::i_am("Scripts/Rmd_Scripts/MSGDM_multipanel_plot.Rmd")
library(tidyverse)
library(ggpubr)
library(mgcv)
library(mgcViz)
...
#### create a new list with the panels in the order needed for plotting (they are plotted row-wize but my_panels has them column_Wize)
```{r}
