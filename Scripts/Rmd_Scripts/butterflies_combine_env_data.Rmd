...
plot.df2(df = site.by.temp, basemap = gb, main.title ="Temperature")

check <- rast(site.by.temp, crs = "EPSG:27700")

check <- crop(rast[[1]], ext = gb)
check <- mask(check, gb)
...
write_rds(wc.no.zeros, file = here("./Data/Processed_Data/Spatial/wc_no_zerosds"))
