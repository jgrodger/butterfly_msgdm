...
## 3 chunks below should be put at appropriate places in this notebook and for pairplots, update to use ggpairs and add loess fit
...
#### Visualise relationships between x, y, predictors and richness
```{r}
