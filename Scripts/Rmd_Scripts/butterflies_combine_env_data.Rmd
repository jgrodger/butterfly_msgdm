...
# make a datframe for merged data for plotting
comb <- merge(site.by.temp, layers2[[1]], by = "ngr.1km")

# merge each env var dataframe into the combined one
...
png(file= here("./Output/Spatial/Figures/fig_2_env_vars.png"))
plot(comb1)
dev.off() 
 
png(file= here("./Output/Spatial/Figures/fig_s1_other_env_vars.png"))
plot(comb2)
dev.off() 
```
...
#### Save as pdf
```{r}
pdf(file= here("./Output/1122_sites_maps.pdf"))
par(mfrow = c(1,2))
print(pointsmap)
print(pointsmap2)
