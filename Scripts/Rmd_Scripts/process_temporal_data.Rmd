...
```
#### Obtain dataframe with number of years per site, and minimym surveys for each site per year and  in each sampling period in each year
```{r}
...
```{r}
write_csv(site.year.counts, file = paste0(out_path, "/", "three_sites_site_year_counts.csv"))
