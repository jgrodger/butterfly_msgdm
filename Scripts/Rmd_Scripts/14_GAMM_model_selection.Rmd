...
#### Packages
```{r}
here::i_am("Scripts/Rmd_Scripts/14_GAMM_model_selection.Rmd")
library(tidyverse)
#library(tmap)
library(mgcv)
library(gstat)
...
gamm_input <- readRDS(paste0(data_path, "all_species", "_gamm_input.rds"))
...
### WC
```{r}
gamm_input <- readRDS(paste0(data_path, "wc", "_gamm_input.rds"))
```
...
### HS
```{r}
gamm_input <- readRDS(paste0(data_path, "hs", "_gamm_input.rds"))
```
