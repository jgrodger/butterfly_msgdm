...
#csv_path from "Output" directory
print_csv <- function(csv_path, table_caption, my_digits = 3){
  
my_table <- read_csv(here(csv_path))

kable(my_table, digits = my_digits,
...
ts1 <- read_csv(here("Output/Spatial/zeta_declines_decays/all_species/butterfly_occupancy.csv"))
...
```{r fig.cap = "Figure S1. Rank Occupancy for butterfly species in sites in this study", out.width = "100%"}
