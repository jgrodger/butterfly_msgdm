...
```{r , message=FALSE}
occ <- read_csv(here("Output/Spatial/zeta_declines_decays/all_species/butterfly_occupancy.csv"))

kable(occ, digits = 3,
      caption = "Table S1. Occupancy of butterflies in the site used for this study")
```
