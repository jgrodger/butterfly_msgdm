...
my_caption <- paste0("Table ", tab_no, ".", tab_cap)
...
```{r , message=FALSE}
print_csv("Output/Spatial/zeta_declines_decays/all_species/butterfly_occupancy.csv",
          "Table S1. Occupancy of butterflies in the site used for this study")
...
#### GAMs and GAMMs
```{r , message=FALSE}
print_csv("Output/Spatial/GAM/GAM_all_species/family_aic_table.csv",
          "Table S2. Comparison of GAM models for different distribution of species richness for the All Species dataset.")
```

```{r , message=FALSE}
print_csv("Output/Spatial/GAM/GAM_wc/family_aic_table.csv",
          "Table S3. Comparison of GAM models for different distribution of species richness for the Wider Countryside dataset.")
```
