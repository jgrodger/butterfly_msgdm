...
# Parameterised Report Building Script
...
#### Packages
```{r 1 Load Packages}
here::i_am("Scripts/Rmd_Scripts/5_Call_msgdm_and_gamm_scripts.Rmd")
...
render_report = function(analysis_script, params_list) {
  out_path <- if (analysis_script == "6_Zeta_declines_decays_analyses.Rmd"){
                ...
                } else if(analysis_script ==  "7_Zeta_msgdm_change_seed_analyses.Rmd") {
                    paste0(here("Output/Spatial/msgdms/"), "/", params_list$dataset, "_" , params_list$normalize_msgdm, "_" , params_list$my_seed)                 
                } else if(analysis_script == "9_process_msgdm_results.Rmd"){  
                      paste0(here("Output/Spatial/msgdms"), "/", 
                      params_list$dataset, "_" , params_list$normalize_msgdm, "/", 
                      "figs_tables/")
                }else if(analysis_script == "10_GAM_compare_family_analyses.Rmd") {
                      paste0(here("Output/Spatial/GAM"), "/","GAM", "_" , params_list$dataset,  "/")  
                } else if(analysis_script == "11_GAM_compare_spline_analyses.Rmd") {
                      paste0(here("Output/Spatial/GAM"), "/","GAM", "_" , params_list$dataset,  "/")
                } else if(analysis_script == "13_process_GAMM_analyses.Rmd"){  
                      paste0(here("Output/Spatial/GAM/GAMM_"), params_list$dataset, "/", 
                             params_list$analysis,  "//")
                } else if(analysis_script == "15_process_GAMMS_single_result_output.Rmd"){  
                      paste0(here("Output/Spatial/GAM/GAMM_"), params_list$dataset, "/", 
...
# All species
tic()
render_report(analysis_script = "7_Zeta_msgdm_change_seed_analyses.Rmd", list(dataset = "all_species",
...
```{r}
render_report(analysis_script = "9_process_msgdm_results.Rmd", 
...
#### Generate a overlapping but different set of tables and figures for msgdms
...
```{r}
render_report(analysis_script = "10_GAM_compare_family_analyses.Rmd", list(dataset = "all_species"))
Sys.Date()
```


```{r}
render_report(analysis_script = "10_GAM_compare_family_analyses.Rmd", list(dataset = "wc"))
Sys.Date()
```

```{r}
render_report(analysis_script = "10_GAM_compare_family_analyses.Rmd", list(dataset = "hs"))
Sys.Date()
```
...
```{r}
render_report(analysis_script = "11_GAM_compare_spline_analyses.Rmd", list(dataset = "all_species"))
```

```{r}
render_report(analysis_script = "11_GAM_compare_spline_analyses.Rmd", list(dataset = "wc"))
```

```{r}
render_report(analysis_script = "11_GAM_compare_spline_analyses.Rmd", list(dataset = "hs", family = "nb"))
```
...
#### All species
```{r}
render_report(analysis_script = "13_process_GAMM_analyses.Rmd", 
...
render_report(analysis_script = "15_process_GAMMS_single_result_output.Rmd",
              list(dataset = "all_species",
