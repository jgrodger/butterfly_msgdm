...
params:
  dataset: "all_species"
  gamm_file: "gamm_all_species_exp_gaus2.rds"
---
...
data_path <- here(paste0("./Data/Processed_Data/Spatial/", params$dataset, ".rds"))
...
#### Datasets for gamms
```{r}
my_gamm <- readRDS(paste0(out_path, params$gamm_file))
