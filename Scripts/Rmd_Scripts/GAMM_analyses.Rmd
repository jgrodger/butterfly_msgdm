...
filedir <- paste0(here(out_path), "/GAMM_wc")
if(!dir.exists(filedir)) dir.create(filedir)
filepath <- paste0(filedir, "/gamm_wc_exp_gaus2_reduced_mod.rds")
filepath
...
try(gamm_hs <- gamm(
  ...
  data = datasets$hs$gamm_input,
  family = negbin(theta = 4.679)))#value from gam


filedir <- paste0(here(out_path), "/GAMM_hs")
if(!dir.exists(filedir)) dir.create(filedir)
filepath <- paste0(filedir, "/gamm2_hs_lin_nb_reduced_mod.rds")
filepath
