...
p16 <- p16a +
  ...
  theme(axis.title = element_text(size = 5),
        axis.text = element_text(size = 4)) +
  annotation_custom(grid::textGrob("P", 0.2, 0.95, gp = grid::gpar(fontsize = 7))) +
  coord_cartesian(ylim = c(14, 23))
...
p17 <- p17a +
 ...
 theme(axis.title = element_text(size = 5),
        axis.text = element_text(size = 4)) +
  annotation_custom(grid::textGrob("Q", 0.2, 0.95, gp = grid::gpar(fontsize = 7))) +
  coord_cartesian(ylim = c(10, 18))
...
p18 <- p18a +
  ...
  theme(axis.title = element_text(size = 5),
        axis.text = element_text(size = 4)) +
  annotation_custom(grid::textGrob("R", 0.2, 0.95, gp = grid::gpar(fontsize = 7))) +
  coord_cartesian(ylim = c(-0.55, 1.75))
...
```{r}
# tjhis is a function from mgcViz
gridPrint(p1, p2, p3, 
          p4, p5, p6,
          p7, p8, p9,
          p10, p11, p12,
