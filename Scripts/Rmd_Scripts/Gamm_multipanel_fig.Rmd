...
---
`
# This makes figure 3 and equivalent for BES
...
gridPrint(p2b, p5b, p8b, p11b, p14b, p17b,
          p3b, p6b, p9b, p12b, p15b, p18b,
          respect=TRUE,
          ncol = 6)

# as above, write to file
png(file = paste0(out_path, "gamm_multiplot_bes.png"), pointsize=10, width=7000, height=2000, res=600)
gridPrint(p2b, p5b, p8b, p11b, p14b, p17b,
          p3b, p6b, p9b, p12b, p15b, p18b,
          respect=TRUE,
          ncol = 6)
