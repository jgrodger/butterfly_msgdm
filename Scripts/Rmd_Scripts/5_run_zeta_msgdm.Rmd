...
# run the setup chunk and the functions chunk, then run the chunks for the analyses desired
...
render_report = function(analysis_script, params_list) {
  out_path <- if (analysis_script == "6_Zeta_declines_decays_analyses.Rmd"){
                ...
                } else if(analysis_script == "14_process_GAMMS_single_result_output.Rmd"){  
                      paste0(here("Output/Spatial/GAM/GAMM_"), params_list$dataset, "/", 
...
##### sink() didn't work this way so instead I changed the param in 14_process_GAMMS_single_result_output.Rmd and ran it

#### All species
```{r}

render_report(analysis_script = "14_process_GAMMS_single_result_output.Rmd",
              list(dataset = "all_species",
