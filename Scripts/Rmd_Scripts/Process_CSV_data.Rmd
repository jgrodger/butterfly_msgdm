...
#make number of surveys per period into colums by pivot wider
...
records <- merge(records, surveys.by.period2, by = "site.year")
...
#filter records to site years sampled in 4 main periods
```{r}
...
#yes, I know this is mostly a copy and paste with 4th line below added
