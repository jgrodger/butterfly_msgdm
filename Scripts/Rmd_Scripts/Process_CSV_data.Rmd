...
print("rows of sites after removing moths and low taxonomic resolution and no butterflies seen categories")
nrow(sites)

print("sites in records")
length(unique(records$site))

print("rows of records removing records of moths and low taxonomic resolution and no butterflies seen categories ")
nrow(records)
