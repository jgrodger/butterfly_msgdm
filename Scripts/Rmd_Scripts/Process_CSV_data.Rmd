...
#66 here sites  were not in site data from Rob , they must have been filtered out from the data he used for some reason
...
plot(coverage~years.15.19, data = sites)
...
# change above, sites restricted to 2015-2019 now
