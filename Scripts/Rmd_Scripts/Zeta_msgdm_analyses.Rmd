...
write_rds(output0, file = paste0(here(out_path), "/", "zeta_msgdms",  ".rds"))
...
for (i in 1:length(params$orders_msgdm)) {
pie.neg(varparts[[i]][4:7,1], density = c(4, 0, 8, -1),  angle = c(90, 0, 0, 0), labels =  c("distance","undistinguishable","environment","unexplained"), radius = 0.9, main = paste0("Zeta = ", params$orders_msgdm))
}
```
