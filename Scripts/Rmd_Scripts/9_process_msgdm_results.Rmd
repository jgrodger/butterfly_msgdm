...
#### Packages
```{r}
here::i_am("Scripts/Rmd_Scripts/9_process_msgdm_results.Rmd")
...
#### File Paths
```{r}
# Path to data used for the msgdm analysis (which is already done)
...
#### I have not managed to get plots of isplines against environmental data on the original scale. This code is part of an attempt
```{r}
...
#### get data to to make multipanel plot for BES poster using only zeta = 4
```{r}
...
#I have checked and csv over-writes fine
...
#### Below is code that could be developed further for validation
