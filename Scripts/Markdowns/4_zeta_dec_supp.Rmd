...
```{r fig.cap = "Figure S3.1. Zeta diversity decline for All Butterfly Species fr0m zeta orders 1 to 20", out.width = "100%"}
...
```{r fig.cap = "Figure S3.4. Zeta diversity decline for Habitat Specialists from zeta orders 1 to 10. Sites with no habitat specialist species were excluded from this analysis.", out.width = "100%"}
...
```{r fig.cap = "Figure S3.5. Comparison of Jaccard, Simpson, and Sorensen dissimilarity for pairs of sites for All Species", out.width = "100%"}
...
```{r fig.cap = "Figure S3.6. Comparison of Jaccard, Simpson, and Sorensen dissimilarity for pairs of sites for Wider Countryside Species", out.width = "100%"}
...
#### Habitat Specialists
```{r fig.cap = "Figure S3.7. Comparison of Jaccard, Simpson, and Sorensen dissimilarity for pairs of sites for Habitat Specialists", out.width = "100%"}
...
#### All Butterfly Species
```{r fig.cap = "Figure S3.8. Zeta diversity decay with distance for , zeta orders 1 to 100", out.width = "100%"}
include_graphics(here("./Output/Spatial/zeta_declines_decays/all_species/all_species_zeta_distance_decays.png"))
```

#### Wider Countryside Species
```{r fig.cap = "Figure S3.9. Zeta diversity decay with distance for , zeta orders 1 to 100", out.width = "100%"}
...
```{r fig.cap = "Figure S3.10. Zeta diversity decay with distance for , zeta orders 1 to 100", out.width = "100%"}
...
```{r fig.cap = "Figure S3.11. Zeta diversity decay with distance for , zeta orders 1 to 100", out.width = "100%"}
