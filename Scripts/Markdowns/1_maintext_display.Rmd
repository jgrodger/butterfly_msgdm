...
```{r fig.cap = "Figure 3. Relationships of species richness with environmental variables for all butterfly species, generalists, and specialists", out.width = "100%"}
include_graphics(here("Output/Spatial/GAM/GAMM_fig/gam_multiplot.png"))
```

```{r fig.cap = "Figure 4. Relationships of species turnover with environmental variables and geographic distance for all butterfly species, generalists, and specialists", out.width = "100%"}
