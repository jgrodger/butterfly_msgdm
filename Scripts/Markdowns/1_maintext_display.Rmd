...
```{r fig.cap = "Figure 3. Relationships of species turnover with environmental variables and geographic distance for all butterfly species, generalists, and specialists", out.width = "100%"}
