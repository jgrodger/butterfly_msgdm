...
---
##  Supplementary Materials Part 4: MSGDMs
...
```{r  message = FALSE}
print_csv("./Output/Spatial/msgdms/wc_Simpson/figs_tables/deviance_table.csv", tab_no = "S4.3", tab_cap = "Deviance explained by MSGDMs for Simpson-Normalized zeta diversity for Wider Countryside Species", my_dig = 3)
```

```{r  message = FALSE}
print_csv("./Output/Spatial/msgdms/wc_Simpson//figs_tables/variance_partitioning_table.csv", tab_no = "S4.4", tab_cap = "Variation partitioning for MSGDMs for Simpson-Normalized zeta diversity for Wider Countryside Species", my_dig = 3)
```
...
```{r  message = FALSE}
print_csv("./Output/Spatial/msgdms/wc_Sorensen//figs_tables/variance_partitioning_table.csv", tab_no = "S4.8", tab_cap = "Variation partitioning for MSGDMs for Sorensen-Normalized zeta diversity for Wider Countryside Species", my_dig = 3)
```


#### Wider Countryside Species, Sorensen
```{r message = FALSE}
print_csv("./Output/Spatial/msgdms/wc_Sorensen/figs_tables/deviance_table.csv", tab_no = "S4.9", tab_cap = "Deviance explained by MSGDMs for Sorensen-Normalized zeta diversity for Wider Countryside Species", my_dig = 3)
```

```{r message = FALSE}
print_csv("./Output/Spatial/msgdms/wc_Sorensen//figs_tables/variance_partitioning_table.csv", tab_no = "S4.10", tab_cap = "Variation partitioning for MSGDMs for Sorensen-Normalized zeta diversity for Wider Countryside Species", my_dig = 3)
```
